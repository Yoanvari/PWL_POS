...
class UserController extends Controller
{
    public function index()
    {
        ...
        $page = (object) [
            'title' => 'Daftar user yangh terdaftar dalam sistem'
        ];
    ...
    public function destroy(string $id)
    {
        ...
        try {
            ...
            return redirect('/user')->with('error', 'Data uder gagal dihapus karena masih terdapat tabel yang terkait dengan data ini');
        }
    }
}
